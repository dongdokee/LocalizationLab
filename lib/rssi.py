# MODIFIED rssi package
# https://github.com/Andyang12138/rssi_module/blob/master/rssi/__init__.py
name = "rssi"

from subprocess import (  # Used to run native OS commads in python wrapped subproccess
    PIPE,
    Popen,
)
...
class RSSI_Localizer(object):
    ...
    def getDistancesForAllAPs(self, signalStrengths):
        ...
        for i in range(len(self.accessPoints)):
            ...
            distanceFromAP = self.getDistanceFromAP(ap, signalStrengths[i])
            apNodes.append(
                {
